...
public class formasli extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        namaa1 = new javax.swing.JLabel();
        namaa = new javax.swing.JLabel();
        nimm1 = new javax.swing.JLabel();
        ...
        jLabel6.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 26)); // NOI18N
        ...
        ruang.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 21)); // NOI18N
        ...
        jPanel1.add(ruang, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 460, -1, 30));

        barang.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 21)); // NOI18N
        ...
        jPanel1.add(barang, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 460, -1, -1));
        ...
        namaa1.setFont(new java.awt.Font("Agency FB", 1, 24)); // NOI18N
        namaa1.setForeground(new java.awt.Color(255, 255, 255));
        namaa1.setText("_______________________");
        jPanel1.add(namaa1, new org.netbeans.lib.awtextra.AbsoluteConstraints(178, 106, 230, 30));

        namaa.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 20)); // NOI18N
        ...
        nimm1.setFont(new java.awt.Font("Agency FB", 1, 24)); // NOI18N
        nimm1.setForeground(new java.awt.Color(255, 255, 255));
        nimm1.setText("________");
        jPanel1.add(nimm1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 160, 230, 30));

        nimm.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 20)); // NOI18N
        ...
        jLabel8.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 26)); // NOI18N
    ...
    private void lRuangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lRuangMouseClicked
        ...
        kriteria="Ruang";
        barang.setForeground(new java.awt.Color(255, 255, 255));
        ruang.setForeground(new java.awt.Color(176,78,31));
    ...
    private void lBarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lBarangMouseClicked
        ...
        kriteria="Barang";
        ruang.setForeground(new java.awt.Color(255, 255, 255));
        barang.setForeground(new java.awt.Color(176,78,31));
...
//                new formasli().setVisible(true);
    ...
    private javax.swing.JLabel namaa1;
    private javax.swing.JLabel nimm;
    private javax.swing.JLabel nimm1;
